    ...
    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-white/20 mx-2 md:mx-0">
      ...
      <div className="space-y-4">
        {tokens.map((token, index) => (
          <div
            key={token.symbol}
            className={`p-4 rounded-xl border transition-all duration-200 hover:scale-[1.02] relative ${
              token.status === 'active'
            ...
            style={token.status === 'coming' ? {
              boxShadow: '0 0 20px rgba(168, 85, 247, 0.3), 0 0 40px rgba(168, 85, 247, 0.1), inset 0 0 20px rgba(168, 85, 247, 0.1)',
