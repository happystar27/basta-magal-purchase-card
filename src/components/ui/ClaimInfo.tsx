    ...
    return (
      <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-white/20">
        <div className="text-center py-8">
          ...
          <h3 className="text-white font-semibold text-lg mb-2">Error Loading Claim Info</h3>
          <p className="text-white/70 text-sm mb-4">{error}</p>
          <button
            onClick={fetchClaimerInfo}
            className="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-navy-900 rounded-lg font-medium transition-colors"
          >
            Try Again
          </button>
        </div>
